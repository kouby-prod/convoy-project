...
/* ═══════════════════════════════════════════════════════════════════════════
   ...
   (`/mes-documents`) and the mobile "Mes documents" screen.
   ...
   handshake:
     ...
     2. PUT  <that URL>             → the CLIENT sends the bytes to the bucket
...
/**
 * Upload limits, shared so the client can reject a bad file before spending a
...
/** What the client declares about the file before it is allowed to upload. */
